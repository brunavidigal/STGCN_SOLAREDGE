...
def build_model(inputs, n_his, Ks, Kt, blocks, keep_prob, act_func):
    """
    ...
    :param act_func: function activation.
    """
    x = inputs[:, 0:n_his, :, :]
    ...
    for i, channels in enumerate(blocks):
        x = st_conv_block(x, Ks, Kt, channels, i, keep_prob, act_func=act_func)
        Ko -= 2 * (Ks - 1)
...
def models_save(sess, global_steps, model_name, save_path='./output/models/'):
    """
