...
from scripts_aux.utils.data_utils import gen_batch
from tester import model_inference
from base_model import build_model, models_save
...
def model_train(inputs, blocks, args, sum_path='./output/_tensorboard'):
    """
    Train the base model.
    :param inputs: instance of class Dataset, data source for training.
    :param blocks: list, channel configs of st_conv blocks.
    :param args: instance of class argparse, args for training.
    :param sum_path: path of dir
    """
    ...
    # Define model loss
    train_loss, pred = build_model(x, n_his, Ks, Kt, blocks, keep_prob, act_func='GLU')
